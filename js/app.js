...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-primary fs-5" style="margin-top: 10px;
      margin-bottom: 10px;padding-top: 6px; padding-bottom: 6px;">add to cart</button>
      <button id="details-btn" class="btn btn-secondary fs-5" style="margin-top: 10px;
      margin-bottom: 10px;padding-top: 6px; padding-bottom: 6px;">Details</button></div>
      `;
