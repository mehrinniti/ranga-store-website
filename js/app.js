...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product bg-info p-2 text-dark bg-opacity-10 m-4">
      <div>
    <img class="product-image" src=${product.image}></img>
      ...
      <h4> ${product.rating.rate}
      <br>
      <i class="fas fa-star filled"></i>
      <i class="fas fa-star filled"></i>
      <i class="fas fa-star filled"></i>
      <i class="fas fa-star filled"></i>
      <i class="fas fa-star emty"></i>
      </h4>
      <h4>Total <i class="fas fa-user"></i> ${product.rating.count} </h4>
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-primary fs-5" style="margin-top: 10px; margin-bottom: 10px;padding-top: 6px; padding-bottom: 6px;">add to cart</button>
      <button id="details-btn" class="btn btn-secondary fs-5" style="margin-top: 10px; margin-bottom: 10px;padding-top: 6px; padding-bottom: 6px;">Details</button></div>
      `;
    document.getElementById("all-products").appendChild(div);
  }
};

//  addToCart button details
let count = 0;
